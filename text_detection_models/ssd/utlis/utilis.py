...
from .bboxes import iou, non_maximum_suppression, non_maximum_suppression_slow
from .visualation import to_rec
...
class PriorMap(object):
    ...
    def compute_priors(self):
        ...
        if self.step is None:
            ...
            assert step_x % 1 == 0 and step_y % 1 == 0, 'map size %s not constiten with input size %s' % (
                map_size, image_size)
        else:
